    ...
    return new Promise((resolve, reject) => {
        axios
            ...
            .then((res) => {
                ...
                context.commit("updateAbilities", res.data.user);
                resolve(res);
            })
            .catch((err) => {
                reject(err);
...
export function changeProfile(context, payload) {
    return new Promise((resolve, reject) => {
        axios
            .patch("profile/update", payload.inputs)
            .then((res) => {
                context.commit("updateProfile", res.data.user);
                resolve(res);
            })
...
export function changeImage(context, payload) {
    return new Promise((resolve, reject) => {
        axios
            .post("change/image", payload.inputs)
            .then((res) => {
                context.commit("updateProfile", res.data.user);
                resolve(res);
            })
...
export function checkPassword(context, payload) {
    return new Promise((resolve, reject) => {
        axios
            .post("password/check", payload.inputs)
            .then((res) => {
                resolve(res);
            })
            .catch((err) => {
...
export function changePassword(context, payload) {
    return new Promise((resolve, reject) => {
        axios
            .patch("password/change", payload.inputs)
            .then((res) => {
                resolve(res);
            })
            .catch((err) => {
