    ...
    <div>
        ...
        <div v-if="products.length" class="body table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="(product, key) in products">
                        ...
                        <td class="text-center">
                            <div v-if="$can('status-product')" class="demo-switch">
                                <div class="switch" style="min-width: auto">
                                    <label
                                        ><input
                                            @change="changeStatus(product)"
                                            type="checkbox"
                                            :checked="product.status" /><span class="lever"></span
                                    ></label>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            <button
                                ...
                                @click="handleEditButtonClick(product)"
                                data-toggle="modal"
            ...
            <div style="display: flex; align-items: center">
                ...
                <pagination :pagination-meta="paginationMeta" @handlePagination="handlePagination" />
            </div>
        </div>
